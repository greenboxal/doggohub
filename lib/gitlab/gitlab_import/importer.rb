module Gitlab
  module GitlabImport
    class Importer
        ...
        ActiveRecord::Base.no_touching do
          ...
          issues.each do |issue|
            ...
            project.issues.create!(
              ...
              author_id: doggohub_user_id(project, issue["author"]["id"]),
      ...
      def doggohub_user_id(project, doggohub_id)
        user = User.joins(:identities).find_by("identities.extern_uid = ? AND identities.provider = 'doggohub'", doggohub_id.to_s)
