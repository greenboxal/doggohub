unless Rails.env.production?
  ...
  namespace :teaspoon do
    desc 'DoggoHub | Teaspoon | Generate fixtures for JavaScript tests'
    ...
    desc 'DoggoHub | Teaspoon | Run JavaScript tests'
    task :tests do
  ...
  desc 'DoggoHub | Teaspoon | Shortcut for teaspoon:fixtures and teaspoon:tests'
  task :teaspoon do
