namespace :doggohub do
  namespace :import do
    ...
    #  2. run: bundle exec rake doggohub:import:repos RAILS_ENV=production
    #
    # Notes:
    #  * The project owner will set to the first administator of the system
    #  * Existing projects will be skipped
    #
    desc "DoggoHub | Import bare repositories from repositories -> storages into DoggoHub project instance"
