namespace :doggohub do
  namespace :import do
    desc "DoggoHub | Add all users to all projects (admin users are added as masters)"
    ...
    desc "DoggoHub | Add a specific user to all projects (as a developer)"
    ...
    desc "DoggoHub | Add all users to all groups (admin users are added as owners)"
    ...
    desc "DoggoHub | Add a specific user to all groups (as a developer)"
