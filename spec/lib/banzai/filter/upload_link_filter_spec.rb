  ...
  context 'with a valid repository' do
    it 'rebuilds relative URL for a link' do
      ...
      expect(doc.at_css('a')['href']).
        to eq "#{Gitlab.config.doggohub.url}/#{project.path_with_namespace}/uploads/e90decf88d8f96fe9e1389afc2e4a91f/test.jpg"
    ...
    it 'supports Unicode filenames' do
      ...
      expect(doc.at_css('img')['src']).to match "#{Gitlab.config.doggohub.url}/#{project.path_with_namespace}/uploads/%ED%95%9C%EA%B8%80.png"
    end
  end
