  ...
  describe '#call' do
    ...
    describe 'when go-get=1' do
      it 'returns a document' do
        ...
        expected_body = "<!DOCTYPE html><html><head><meta content='#{Gitlab.config.doggohub.host}/group/project git http://#{Gitlab.config.doggohub.host}/group/project.git' name='go-import'></head></html>\n"
