...
DoggoHub 6.1 is affected by critical security vulnerabilities CVE-2013-4490 and CVE-2013-4489.
...
# For DoggoHub Enterprise Edition: sudo -u git -H git checkout 6-1-stable-ee
```
...
- Make `/home/git/doggohub/config/doggohub.yml` same as https://doggohub.com/doggohub-org/doggohub-ce/blob/6-1-stable/config/doggohub.yml.example but with your settings.
- Make `/home/git/doggohub/config/unicorn.rb` same as https://doggohub.com/doggohub-org/doggohub-ce/blob/6-1-stable/config/unicorn.rb.example but with your settings.
