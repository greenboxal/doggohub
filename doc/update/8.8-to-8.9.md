...
```sh
git diff origin/8-8-stable:config/doggohub.yml.example origin/8-9-stable:config/doggohub.yml.example
```
...
git diff origin/8-8-stable:lib/support/nginx/doggohub-ssl origin/8-9-stable:lib/support/nginx/doggohub-ssl

# For HTTP configurations
git diff origin/8-8-stable:lib/support/nginx/doggohub origin/8-9-stable:lib/support/nginx/doggohub
```
...
[/etc/default/doggohub]: https://doggohub.com/doggohub-org/doggohub-ce/blob/8-9-stable/lib/support/init.d/doggohub.default.example#L37
