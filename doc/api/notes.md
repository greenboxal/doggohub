...
```bash
curl --request DELETE --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" https://doggohub.example.com/api/v3/projects/5/issues/11/notes/636
```
...
```json
{
  ...
  "author": {
    ...
    "web_url": "https://doggohub.example.com/pipin"
  },
...
```bash
curl --request DELETE --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" https://doggohub.example.com/api/v3/projects/5/snippets/52/notes/1659
```
...
```bash
curl --request DELETE --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" https://doggohub.example.com/api/v3/projects/5/merge_requests/7/notes/1602
```
