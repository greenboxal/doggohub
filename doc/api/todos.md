...
> [Introduced][ce-3188] in DoggoHub 8.10.
...
```bash
curl --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" https://doggohub.example.com/api/v3/todos
```
...
[
  {
    ...
    "target_url": "https://doggohub.example.com/doggohub-org/doggohub-ce/merge_requests/7",
...
```bash
curl --request DELETE --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" https://doggohub.example.com/api/v3/todos/130
```
...
```bash
curl --request DELETE --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" https://doggohub.example.com/api/v3/todos
```
...
[ce-3188]: https://doggohub.com/doggohub-org/doggohub-ce/merge_requests/3188
