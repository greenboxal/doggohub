...
> [Introduced][ce-4575] in DoggoHub 8.9, Snippet support in 8.12
...
```bash
curl --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/award_emoji
```
...
[
  {
    ...
    "user": {
      ...
      "web_url": "http://doggohub.example.com/root"
    },
  ...
  },
  {
    ...
    "user": {
      ...
      "web_url": "http://doggohub.example.com/user4"
    },
...
```bash
curl --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/award_emoji/1
```
...
```bash
curl --request POST --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/award_emoji?name=blowfish
```
...
```bash
curl --request DELETE --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/award_emoji/344
```
...
```bash
curl --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/notes/1/award_emoji
```
...
```bash
curl --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/notes/1/award_emoji/2
```
...
```bash
curl --request POST --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/notes/1/award_emoji?name=rocket
```
...
```bash
curl --request DELETE --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" http://doggohub.example.com/api/v3/projects/1/issues/80/award_emoji/345
```
...
[ce-4575]: https://doggohub.com/doggohub-org/doggohub-ce/merge_requests/4575
