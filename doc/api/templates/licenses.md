...
```bash
curl https://doggohub.example.com/api/v3/templates/licenses?popular=1
```
...
```bash
curl --header "PRIVATE-TOKEN: 9koXpg98eAheJpvBs5tK" https://doggohub.example.com/api/v3/templates/licenses/mit?project=My+Cool+Project
```
