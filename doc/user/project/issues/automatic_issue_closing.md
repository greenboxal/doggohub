...
Note that `%{issue_ref}` is a complex regular expression defined inside DoggoHub's
...
(`https://doggohub.example.com/group/project/issues/123`).
...
and https://doggohub.example.com/group/otherproject/issues/23.
```
