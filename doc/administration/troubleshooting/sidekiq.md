...
Sidekiq is the background job processor DoggoHub uses to asynchronously run
...
> **Note:** DoggoHub administrators/users should consider working through these
debug steps with DoggoHub Support so the backtraces can be analyzed by our team.
It may reveal a bug or necessary improvement in DoggoHub.
...
Check in `/var/log/doggohub/sidekiq/current` or `$DOGGOHUB_HOME/log/sidekiq.log` for
...
2016-04-13T06:21:20.022Z 31517 TID-orn4urby0 WARN: /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/activerecord-4.2.5.2/lib/active_record/core.rb:155:in `find'
/opt/doggohub/embedded/service/doggohub-rails/app/workers/new_note_worker.rb:7:in `perform'
/opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/sidekiq-4.0.1/lib/sidekiq/processor.rb:150:in `execute_job'
/opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/sidekiq-4.0.1/lib/sidekiq/processor.rb:132:in `block (2 levels) in process'
/opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/sidekiq-4.0.1/lib/sidekiq/middleware/chain.rb:127:in `block in invoke'
/opt/doggohub/embedded/service/doggohub-rails/lib/doggohub/sidekiq_middleware/memory_killer.rb:17:in `call'
/opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/sidekiq-4.0.1/lib/sidekiq/middleware/chain.rb:129:in `block in invoke'
/opt/doggohub/embedded/service/doggohub-rails/lib/doggohub/sidekiq_middleware/arguments_logger.rb:6:in `call'
...
```
...
this obvious you should then go investigate what job in DoggoHub would use
...
from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
...
```
...
# Example output
#0  0x00007ff0d6afe111 in xmlXPathNodeSetMergeAndClear () from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
#1  0x00007ff0d6b0b836 in xmlXPathNodeCollectAndTest () from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
#2  0x00007ff0d6b09037 in xmlXPathCompOpEval () from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
#3  0x00007ff0d6b09017 in xmlXPathCompOpEval () from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
#4  0x00007ff0d6b092e0 in xmlXPathCompOpEval () from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
#5  0x00007ff0d6b0bc37 in xmlXPathRunEval () from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
#6  0x00007ff0d6b0be5f in xmlXPathEvalExpression () from /opt/doggohub/embedded/service/gem/ruby/2.1.0/gems/nokogiri-1.6.7.2/lib/nokogiri/nokogiri.so
