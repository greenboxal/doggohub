...
> [Introduced][ce-3232] in DoggoHub 8.7. It is OFF by default because it still
causes too many false alarms.

Git has a built-in mechanism, [git fsck][git-fsck], to verify the
integrity of all data committed to a repository. DoggoHub administrators
...
DoggoHub periodically runs a repository check on all project repositories and
...
fail their repository checks all DoggoHub administrators will receive an email
...
`/var/log/doggohub/doggohub-rails` for Omnibus installations or
`/home/git/doggohub/log` for installations from source). Once you have
...
---
[ce-3232]: https://doggohub.com/doggohub-org/doggohub-ce/merge_requests/3232 "Auto git fsck"
